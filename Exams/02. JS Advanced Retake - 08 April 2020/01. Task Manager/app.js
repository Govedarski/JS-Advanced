function solve() {
    ...
    function add(e) {
        ...
        ('p', {textContent:`Due Date: ${dueDate}`})
        ('div', {className:CONST.DIV_FOR_BUTTONS_CLASS}, true);
        helpers.createAndAppendElementWithAttrs.bind(div)
        ('button', {textContent:CONST.START_BUTTON_TITLE, className:CONST.START_BUTTON_CLASS})
        ('button', {textContent:CONST.DELETE_BUTTON_TITLE, className:CONST.DELETE_BUTTON_CLASS});
    ...
    function start(e) {
        ...
        ('button', {textContent:CONST.FINISH_BUTTON_TITLE, className:CONST.FINISH_BUTTON_CLASS});
    ...
    const helpers = {
        ...
        createAndAppendElementWithAttrs(elementName, kwargs, returnElement = false,) {
